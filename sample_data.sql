...
values(5050, 'both', 'Constant', 'Gradual', 'Year Ago','Y', 'Very loud', 'Y', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 5, 5, 5, 'Not sure about severity', 'Y', 'Everyday', 'None', 'hours', 'Y', 50, 'Y', 'None', 'Intefersr with life', 'Y', 'Y', 'Ringing', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'Y', 'Y', 'Y', 'N', 5, 5, 5, 'No comment', 'Y', 'Everyday', 'Stronger', 'days', 'Y', 50, 'Y', 'None', 'Severity is issue', 'Y', 'Y', 'In Ear', 'N', 'Tinnitus', 'Hearing Aid', 5, 4, 3, 'Agrees', '1 month' Null, Null, Null, Null, Null, 8090);
