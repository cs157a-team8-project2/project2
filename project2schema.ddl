...
CREATE TABLE interview (
    ...
    fui_activities_changes     VARCHAR2(1),
    fui_activities_changes_1   VARCHAR2(1),
    fui_problem_in_general     VARCHAR2(6),
    fui_glad_started           VARCHAR2(2),
    fui_main_prob_disc         VARCHAR2(100),
    vist_visit_id              INTEGER NOT NULL
);
...
ALTER TABLE vist ADD CONSTRAINT vist_pk PRIMARY KEY ( visit_id );

ALTER TABLE interview
    ADD CONSTRAINT interview_vist_fk FOREIGN KEY ( vist_visit_id )
        REFERENCES vist ( visit_id );

ALTER TABLE vist
    ADD CONSTRAINT vist_clinic_fk FOREIGN KEY ( clinic_clinic_number )
        REFERENCES clinic ( clinic_number );

ALTER TABLE vist
    ADD CONSTRAINT vist_interview_fk FOREIGN KEY ( interview_id )
        REFERENCES interview ( id );

ALTER TABLE vist
    ADD CONSTRAINT vist_patient_fk FOREIGN KEY ( patient_thc )
